...
class FaceDetector:
    def __init__(self):
        ...
        self.warning_duration = 5  # Warning duration in seconds
    ...
    # Add the "Test auto-submitted" text to the black frame on two lines
...
def main():
    ...
    try:
        ...
        if detector.test_auto_submitted:
            # If the test was auto-submitted, show a black screen with the text
            black_frame = detector.get_black_frame_with_text()
            for _ in range(100):  # Show the black frame for ~5 seconds (150 frames at 30 FPS)
